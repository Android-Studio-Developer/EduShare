...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    const tickerFn = () => {
      if (!activeTarget || !targetCornerPositionsRef.current || !cursorRef.current || !cornersRef.current) {
        return;
      }
      ...
      // Re-measure every frame instead of trusting the mouseenter snapshot —
      // targets that resize/move under hover (animated buttons, magnifying
      // dock icons) would otherwise leave the corners drifting off them.
