...
import { sendDisputeMessage, subscribeToDisputeMessages, subscribeToReport } from "../lib/moderation";
...
export default function DisputeRoom() {
  ...
  const participant = role === "owner" || role === "moderator" || user?.uid === report.reporterId || user?.uid === report.serverOwnerId;
